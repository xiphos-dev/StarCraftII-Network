...
ruta_modelo = "../../../../Modelo_convolucional/Protoss/modelo88f_dobleplano_drop_sinpadding_p"
...
with open('../../../../Modelo_convolucional/Protoss/modelo88f_dobleplano_drop_sinpadding_p', 'wb') as file_pi:
