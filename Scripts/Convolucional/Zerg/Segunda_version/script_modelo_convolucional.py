...
ruta_modelo = "../../../../Modelo_convolucional/Zerg/modelo88f_dobleplano_drop_sinpadding_t"
...
with open('../../../../Modelo_convolucional/Zerg/historial_modelo88f_dobleplano_drop_sinpadding_t', 'wb') as file_pi:
