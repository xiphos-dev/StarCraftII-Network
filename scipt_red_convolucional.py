...
ruta = "./"
archivo = "midgame_con_puntero_corregido.csv"
file = ruta+archivo
...
print(dataset.shape[0]*0.7)


# In[22]:


X_train, X_test, y_train, y_test = train_test_split(dataset,y,test_size=0.20, random_state=100)
...
ruta_modelo = "./Modelo_convolucional"
...
with open('./Modelo_convolucional/trainHistoryDict', 'wb') as file_pi:
